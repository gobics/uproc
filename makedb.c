...
void calib(void)
{
    ...
    uproc_ecurve *fwd = uproc_database_ecurve_forward(database_);
    uproc_ecurve *rev = uproc_database_ecurve_reverse(database_);
...
int main(int argc, char **argv)
{
    ...
    if (flags_calib_only_) {
        ...
        uproc_database_set_ecurve_forward(database_, build_ecurve(false));
        uproc_database_set_ecurve_reverse(database_, build_ecurve(true));
    ...
    if (flags_calib_only_) {
        ...
        uproc_database_set_ecurve_forward(database_, NULL);
